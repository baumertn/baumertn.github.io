+++
title = "I played: Minds Beneath Us"
date = 2026-04-05
...
autonumber = true
math = true
tags = ["mini-review", "game", "games", "recommendation", "recommended"]
showTags = true
hideBackToTop = false
+++
...
The story has many plot threads. Some of which are resolved by the end of the game, others not.
How the former resolve is dependent on the choices the player makes

I was surprised by the game's decision to have characters with no faces. A bold choice.
