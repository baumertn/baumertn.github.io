...
- The tech is pretty cool. Computers being able to parse written text and "comprehend" it is amazing.
- Usage of AI seems weird to me.
  - Coding: Feels "okay" for web, particularly frontend. Tried it a few times with Ansible, where it sometimes helped othertimes it lead to spending more time.
  - Creative arts: It's fun to use it for memes or some such between friends. But comercilizing that feels off. Any why is there such a big push here?
  - Other fields: Not really my expertise. Hard to judge.
- It seems to me that outsourcing whole tasks to AI is just not working sufficiently well. See the companies that tried to move customer service to AI only.
  - RE: Customer service – I think it could make sense to use AI to assist a customer service rep in a conversation with, for example, assesments of client sentiment.
    But then again, it's not my field. So maybe that's just the skill that a rep should have to learn?
- My usage has become limited.
...
- Fears of replacement:
  - I'm currently not feeling afraid as an engineer.
